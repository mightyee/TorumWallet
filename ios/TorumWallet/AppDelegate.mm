...
//   UIView *rootView = RCTAppSetupDefaultRootView(bridge, @"TorumWallet", initProps,nil);
  RCTRootView *rootView = (RCTRootView *)RCTAppSetupDefaultRootView(bridge, @"TorumWallet", nil);
